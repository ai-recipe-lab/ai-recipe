...
const recipes = [
  {
    ...
    description: "専門知識ゼロでも大丈夫。AIと会話しながら、自分のホームページを作る手順。",
  ...
  },
  {
    ...
    category: "文章・仕事",
    title: "AIで伝わる文章を作る",
    description: "何を書けばいいか分からない時に、AIと一緒に文章を完成させる方法。",
    tools: "ChatGPT",
    level: "かんたん",
    href: "#",
  },
  {
    ...
    category: "画像・デザイン",
    title: "AIでSNS画像を作る",
    description: "デザイン経験がなくても、AIを使って投稿画像のアイデアを形にする方法。",
        ...
        <div className="mt-8 grid gap-6 md:grid-cols-3">
          {filteredRecipes.map((recipe) => (
            ...
            >
              ...
              <h3 className="mt-4 text-xl font-bold leading-7">{recipe.title}</h3>
              <p className="mt-3 text-sm leading-6 text-gray-600">{recipe.description}</p>
